...
FROM ghcr.io/swissgrc/azure-pipelines-dotnet:10.0.102 AS base
...
LABEL org.opencontainers.image.documentation="https://github.com/swissgrc/docker-azure-pipelines-node24-net10"
